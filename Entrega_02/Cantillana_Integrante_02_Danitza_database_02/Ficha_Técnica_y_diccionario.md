...
* **Limitaciones:** Representa una evaluación estandarizada en un periodo determinado, por lo que los índices de calidad pueden requerir actualización frente a intervenciones urbanas recientes.

## 2. Diccionario
| Variable | Descripción |
| :--- | :--- |
| `COMUNA` | Nombre de la comuna donde se ubica la plaza/parque. |
...
| `Luminarias` | Evaluación de la presencia y estado de luminaria. |
| `Basureros` | Disponibilidad y estado de los contenedores de basura. |
| `CALIDAD` | Índice final de calidad del espacio público. |
